...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r collabora
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r collabora -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-collabora
cd docker-collabora
echo aaa  
echo bbb  
...
[Collabora Administrator Guide](https://support.websoft9.com/docs/collabora)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Collabora Enterprise Support](https://apps.websoft9.com/collabora) 
